...
- MultiCheckpointManager: Coordinates multiple checkpoint managers
...
The MultiCheckpointManager enables redundancy, performance optimization, and
environment separation by coordinating multiple checkpoint backends.
"""
